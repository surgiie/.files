return {
	...
	config = function()
		...
		vim.api.nvim_set_hl(0, "BufferLineBackground", { bg = "none", fg = "#828181" })
		vim.api.nvim_set_hl(0, "BufferLineSeparator", { bg = "none", fg = "#545454" })
		vim.api.nvim_set_hl(0, "BufferLineBufferSelected", { bg = "none", fg = "#ffffff" })
		vim.api.nvim_set_hl(0, "BufferLineBufferVisible", { bg = "none", fg = "#ffffff" })
		vim.api.nvim_set_hl(0, "BufferLineModified", { bg = "none", fg = "#fff291" })
